                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                <h4 class="m-0 d-print-none"> KWITANSI BUKTI TIMBANG BARANG </h4>
                                            </div>
                                        ...
                                        <div class="col-md-4 offset-md-2">
                                            <div class="mt-3 float-right">
                                                ...
                                                <p class="m-b-10"><strong> No :  </strong> <span class="float-right"> <b>TIMCO21010001</b> </span></p>
                                            </div>
                                        </div><!-- end col -->
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-6">
                                            <h6> Kasir Gudang </h6>
                                            <address>
                                                <input type="text" name="" id="" value="Janzen" readonly>
                                                <!-- 795 Folsom Ave, Suite 600<br>
                                                San Francisco, CA 94107<br>
                                                <abbr title="Phone">P:</abbr> (123) 456-7890 -->
                                            </address>
