                                ...
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            ...
                                            <li class="breadcrumb-item active"><a href=" {{route('cashier.incoming.index')}}"> Incoming</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-sm-right form-inline">
                                                <!-- <div class="form-group mr-2 text-right">
                                                    <a href="" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div> -->
                                                <div class="form-group mr-2">
                                                    <a href="{{route('cashier.incoming.ttb')}}" id="demo-btn-addrow" class="btn btn-secondary"><i class="mdi mdi-cloud-print mr-2"></i> CETAK TTB </a>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('cashier.incoming.edit')}}" class="btn btn-success btn-sm waves-effect waves-light">
