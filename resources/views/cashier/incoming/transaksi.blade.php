               ...
               <div class="col-6 text-sm form-inline">
                   ...
                   <div class="col-6 text-sm-right  ">
                       <div class="form-group mr-2 text-right">
                           <a href=" {{route('cashier.incoming.ttb')}}" id="demo-btn-addrow" class="btn btn-dark"><i class="mdi mdi-cloud-print mr-2"></i> CETAK TTB </a>
                       </div>
                    </div>
                 </div>
            ...
            <tr>
              ...
              <td>    
                ...
                <div class="text-center">       
                  <a href="{{route('cashier.incoming.edit')}}" class="btn btn-success btn-sm">
