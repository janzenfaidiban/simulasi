...
<div class="row page-titles mx-0 mt-2">
  ...
  <div class="col p-md-0">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href=" {{route('dashboard.acceptance')}} ">Cashier</a></li>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>    
                ...
                <a href=" {{route('cashier.incoming.transaksi')}} " class="btn btn-primary btn-sm">
                  <i class="fa fa-compress"> TAMPILKAN TRANSAKSI </i> 
                  </a>

                <a href="{{route('cashier.incoming.ttb')}}" class="btn btn-secondary btn-sm">
