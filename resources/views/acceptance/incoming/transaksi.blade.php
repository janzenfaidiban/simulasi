...
@section('titile','Acceptance  | Transaksi Incoming')
@section('content')
                                ...
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            ...
                                            <li class="breadcrumb-item active"><a href=" {{route('acceptance.incoming.index')}}"> Incoming</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"> TRANSAKSI INCOMING  </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            <div class="col-6 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="" id="demo-btn-addrow" class="btn btn-success"> TTB-TIMICO21010001  </a>
                                                </div>
                                                <div class="form-group mr-2">
                                            ...
                                            <div class="col-6 text-sm-right form-inline">
                                                <div class="form-group mr-2 text-right">
                                                    <a href=" {{route('acceptance.incoming.create.transaksi')}} " id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                                    <a href="{{route('acceptance.incoming.ttb')}}" id="demo-btn-addrow" class="btn btn-dark"><i class="mdi mdi-cloud-print mr-2"></i> CETAK BTB </a>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('acceptance.incoming.edit.transaksi')}} " class="btn btn-success btn-sm waves-effect waves-light">
