...
@section('titile','Acceptance | Outgoing ')
@section('content')
                                ...
                                <div class="card-box">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="{{ route('acceptance.outgoing.create') }}" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-sort-initial="true" data-toggle="true" class="footable-visible footable-sortable footable-sorted"  width="8%"> TANGGAL <span class="footable-sort-indicator"></span></th>
                                            <th data-sort-initial="true" data-toggle="true" class="footable-visible footable-sortable footable-sorted"  width="15%"> NOMOR BTB <span class="footable-sort-indicator"></span></th>
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="footable-visible">05-02-2021</td>
                                            <td class="footable-visible"> BTB-TIMCO21010001</td>
                                            <td class="footable-visible footable-last-column">SURYAGITA NUSA RAYA</td>
                                            <td class="text-center">
                                                <a href=" {{route('acceptance.outgoing.transaksi')}}" class="btn btn-primary btn-sm waves-effect waves-light">
                                                    <span class="btn-label"><i class="mdi mdi-arrow-collapse"></i></span> Transaksi </a>

                                                <a href="{{route('acceptance.outgoing.btb')}}" class="btn btn-secondary btn-sm waves-effect waves-light">
                                                    <span class="btn-label"><i class="mdi  mdi-cloud-print"></i></span> Cetak BTB </a>
                                                <a href="{{route('acceptance.outgoing.edit')}}" class="btn btn-success btn-sm waves-effect waves-light">
