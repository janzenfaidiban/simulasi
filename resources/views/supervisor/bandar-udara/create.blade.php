...
@section('titile',' Tambah Data Bandar Udara ')
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tambah Data Bandar Udara  </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
    ...
    <div class="card">
                <div class="col-lg-12">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('bandarudara.store') }}" enctype="multipart/form-data">
                                  @csrf     

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label> Nama </label>
                                                <input type="text" class="form-control  @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" required autocomplete="nama" autofocus placeholder="Enter Name">
