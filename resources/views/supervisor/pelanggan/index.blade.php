...
<div class="content-page">
                <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="{{ route('pelanggan.create') }}" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('pelanggan.edit', ['id' => $u->id]) }}" class="btn btn-success btn-sm waves-effect waves-light">
                  ...
                  @foreach($data as $u)
                  <!-- modal hapus -->
                  <form method="POST" action="{{ route('pelanggan.delete',['id' => $u->id]) }}">
