                                ...
                                <div class="card-box">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="{{ route('pengguna.create') }}" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th class="footable-visible footable-sortable text-center">FOTO<span class="footable-sort-indicator"></span></th>                                          
                                            <th class="footable-visible footable-sortable text-center">NAMA LENGKAP<span class="footable-sort-indicator"></span></th>                                          
                                            <th class="footable-visible footable-sortable text-center">NAMA BELAKANG<span class="footable-sort-indicator"></span></th>                                          
                                            <th class="footable-visible footable-sortable text-center">EMAIL<span class="footable-sort-indicator"></span></th>                                                                                 
                                            <th class="footable-visible footable-sortable text-center">USERNAME<span class="footable-sort-indicator"></span></th>                                                                              
                                            <th class="footable-visible footable-sortable text-center">LEVEL PENGGUNA<span class="footable-sort-indicator"></span></th>                                          
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="footable-visible footable-last-column">  {{ $u->nama_depan }} </td>
                                            <td class="footable-visible footable-last-column"> {{ $u->nama_belakang }} </td>
                                            <td class="footable-visible footable-last-column"> {{ $u->username }} </td>
                                            <td class="footable-visible footable-last-column"> {{ $u->email }} </td>
                                            <td class="footable-visible footable-last-column"> {{ $u->level }} </td>
                                         
                                            <td class="text-center">
                            
                                                <a href="" class="btn btn-secondary btn-sm waves-effect waves-light">
                                                    <span class="btn-label"><i class="mdi mdi-card-account-details-star"></i></span> Detail </a>

                                                <a href="{{ route('pengguna.edit', ['id' => $u->id]) }}" class="btn btn-success btn-sm waves-effect waves-light">
