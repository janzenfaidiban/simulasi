...
@section('titile',' Tambah Data Comudity ')
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Tambah Data Comudity  </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
    ...
    <div class="card">
                <div class="col-lg-12">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('comudity.store') }}" enctype="multipart/form-data">
                                  @csrf     
