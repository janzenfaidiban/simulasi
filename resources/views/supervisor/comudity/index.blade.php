...
<div class="content-page">
                <div class="content">
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active"> Comudity </li>
                                            </ol>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"> COMUDITY  </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="{{ route('comudity.create') }}" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th class="footable-visible footable-sortable text-center">NAMA <span class="footable-sort-indicator"></span></th>                                                                                   
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('comudity.edit', ['id' => $u->id]) }}" class="btn btn-success btn-sm waves-effect waves-light">
                  ...
                  @foreach($data as $u)
                  <!-- modal hapus -->
                  <form method="POST" action="{{ route('comudity.delete',['id' => $u->id]) }}">
