...
<div class="content-page">
                <div class="content">
                                ...
                                <div class="card-box">
                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <a href="{{ route('pengaturan.create') }}" id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i>TAMBAH DATA </a>
                                                </div>
                                                <div class="form-group mr-2">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-centered table-striped table-bordered mb-0 toggle-circle footable-loaded footable tablet breakpoint" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th class="footable-visible footable-sortable text-center"> JASA GUDANG <span class="footable-sort-indicator"></span></th>                                                                                   
                                            <th class="footable-visible footable-sortable text-center"> PPN <span class="footable-sort-indicator"></span></th>                                                                                   
                                            <th class="footable-visible footable-sortable text-center">PNBP<span class="footable-sort-indicator"></span></th>                                                                                   
                                            <th class="footable-visible footable-sortable text-center">ADMINISTRASI<span class="footable-sort-indicator"></span></th>                                                                                   
                                        ...
                                        <tr class="footable-even" >
                                            ...
                                            <td class="footable-visible footable-last-column text-center" >  {{ $u->jasa_gudang }} </td>                                      
                                            <td class="footable-visible footable-last-column text-center" >  {{ $u->ppn }} </td>                                      
                                            <td class="footable-visible footable-last-column text-center" >  {{ $u->pnbp }} </td>                                      
                                            <td class="footable-visible footable-last-column text-center" >  {{ $u->administrasi }} </td>                                      
                                            <td class="text-center">

                                                <a href="{{ route('pengaturan.edit', ['id' => $u->id]) }}" class="btn btn-success btn-sm waves-effect waves-light">
                  ...
                  @foreach($data as $u)
                  <!-- modal hapus -->
                  <form method="POST" action="{{ route('pengaturan.delete',['id' => $u->id]) }}">
